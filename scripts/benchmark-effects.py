...
{options.seconds:g} second per case. Timings depend on the installed native build
and concurrent system load; run `maturin develop --release` before making release
